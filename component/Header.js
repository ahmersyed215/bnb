...
import {View,  StyleSheet, TextInput,SafeAreaView ,Image, TouchableWithoutFeedback} from 'react-native';
...
const Header = ({title,pressHandler,navigation}) => {
  ...
  return (
    ...
    <View style={styles.header}>
      <Icon style={styles.icon}  name="arrow-back" size={35} color={textColorBack}   onPress={() => { navigation.goBack()}}></Icon>
